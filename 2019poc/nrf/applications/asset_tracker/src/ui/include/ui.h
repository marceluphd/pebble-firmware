...
enum ui_led_pattern {
	...
	UI_LTE_CONNECTING	= UI_LED_BLINK(DK_LED2_MSK),
	UI_LTE_CONNECTED	= UI_LED_ON(DK_LED2_MSK),
	UI_CLOUD_CONNECTING	= UI_LED_BLINK(DK_LED3_MSK),
	UI_CLOUD_CONNECTED	= UI_LED_ON(DK_LED3_MSK),
	UI_LED_GPS_SEARCHING	= UI_LED_BLINK(DK_LED1_MSK|DK_LED3_MSK),
	UI_LED_GPS_FIX		= UI_LED_ON(DK_LED1_MSK|DK_LED3_MSK),
	UI_CLOUD_PAIRING	= UI_LED_BLINK(DK_LED2_MSK | DK_LED3_MSK),
	UI_ACCEL_CALIBRATING	= UI_LED_ON(DK_LED1_MSK | DK_LED2_MSK),
	UI_LED_ERROR_CLOUD	= UI_LED_BLINK(DK_LED1_MSK ),
	UI_LED_ERROR_BSD_REC	= UI_LED_BLINK(DK_LED1_MSK ),
	UI_LED_ERROR_BSD_IRREC	= UI_LED_BLINK(DK_ALL_LEDS_MSK),
	UI_LED_ERROR_LTE_LC	= UI_LED_BLINK(DK_LED1_MSK),
